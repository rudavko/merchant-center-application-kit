...
import { ExternalSiteLink } from '@commercetools-docs/gatsby-theme-docs/src/components';
import LogoSvg from '@commercetools-docs/gatsby-theme-docs/src/icons/logo.svg';
