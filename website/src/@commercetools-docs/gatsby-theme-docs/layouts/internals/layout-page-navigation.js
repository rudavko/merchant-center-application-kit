...
import UnstyledStackedLinesIndentedIcon from '@commercetools-docs/gatsby-theme-docs/src/icons/stacked-lines-indented-icon.svg';
import { Overlay } from '@commercetools-docs/gatsby-theme-docs/src/components';
